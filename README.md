...
| --- | --- | --- | --- |
| alfresco | 8080 | Browser access to Drupal Document by http | Y |
| postgres | 5432 | Accessing Postgres database with TCP | Y |
## Documentation

[Alfresco Administrator Guide](https://support.websoft9.com/docs/alfresco)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Alfresco Enterprise Support](https://apps.websoft9.com/alfresco) 
